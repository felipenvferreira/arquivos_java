...
public class Program {
	...
	public static void main(String[] args) {
		...
		/*
		 variaveis são espaços alocados na memória que salvam uma informação (um dado)
		 ...
		 char é o tipo que armazena um caractere é um tipo "literal" e sua inicialização é feita com aspas simples
		 exemplos de char: c, d, a, 1, 2...
		 String é uma classe do java utilizada para armazenar cadeias de caracteres
